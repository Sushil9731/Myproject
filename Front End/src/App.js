  ...
  render() {
    ...
    return (
      <BrowserRouter>
        ...
        <div class="navbar navbar d-flex flex-column flex-md-row align-items-center mb-1 border-bottom bg-info">
          <div class="d-flex align-items-center text-dark text-decoration-none ">
            <div className="navbar-brannavbar navbar-expand-lg navbar-light bg-light" >
